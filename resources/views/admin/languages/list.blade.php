            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    @if(hasPermission("user.create"))
                        <a href="{{ route("admin.languages.create") }}" title="Yeni Rol">
                ...
                <div class="card card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="keyword" name="keyword" data-role="keyword" value="{{ request()->keyword ?: "" }}" placeholder="Ad, Orjinal Ad, Kod...">
                        </div>
            ...
            <div class="table-responsive">
                <table class="table" data-role="table">
                    ...
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">Ad</th>
                        <th scope="col">Orginal adı</th>
                        <th scope="col">Kod</th>
                        <th scope="col">Bayraq</th>
...
@push("js")
    <script>
        let languages_route =  "{{ route("admin.languages.list") }}",
            languages_edit_route = "{{ route("admin.languages.edit", "language_id") }}",
            languages_delete_route = "{{ route("admin.languages.delete", "language_id") }}",
            languages_change_status_route = "{{ route("admin.languages.change-status", "language_id") }}";
    </script>
    <script src="{{ asset("assets/admin/custom/js/languages/list.js") }}"></script>
@endpush
