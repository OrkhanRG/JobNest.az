    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between">
                ...
                <div>
                    @if(hasPermission("currency.create"))
                        <a href="{{ route("admin.currencies.create") }}" title="Yeni Valyuta">
                ...
                <div class="card card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="keyword" name="keyword" data-role="keyword" value="{{ request()->keyword ?: "" }}" placeholder="Ad, Kod, Kurs, Simvol...">
                        </div>
            ...
            <div class="table-responsive">
                <table class="table" data-role="table">
                    ...
                    <tr>
                        ...
                        <th scope="col">Simvol</th>
                        <th scope="col">Aktivdir?</th>
                        <th scope="col">Defaultdur?</th>
...
@push("js")
    <script>
        let currencies_route =  "{{ route("admin.currencies.list") }}",
            currencies_edit_route = "{{ route("admin.currencies.edit", "currency_id") }}",
            currencies_delete_route = "{{ route("admin.currencies.delete", "currency_id") }}",
            currencies_change_status_route = "{{ route("admin.currencies.change-status", "currency_id") }}";
    </script>
    <script src="{{ asset("assets/admin/custom/js/currencies/list.js") }}"></script>
@endpush
