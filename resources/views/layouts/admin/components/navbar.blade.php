    ...
    <div class="container-xxl">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center gap-1">
                <!-- Redirect to JobNest -->
                <div class="topbar-item">
                    <a href="{{ route("front.index") }}" title="JobNest">
                        <iconify-icon
                            icon="iconamoon:arrow-left-5-circle-duotone"
                ...
                <div class="dropdown topbar-item d-none d-lg-flex">
                    ...
                    <div class="dropdown-menu dropdown-menu-end p-0">
                        <div class="p-1">
                            ...
                            >
                                <img
                                    src="{{ asset("assets/admin/images/brands/github.svg") }}"
                                    class="avatar-xs"
                                    alt="Github"
                                />
                                <span class="ms-2"
                            ...
                            >
                                <img
                                    src="{{ asset("assets/admin/images/brands/bitbucket.svg") }}"
                                    class="avatar-xs"
                                    alt="bitbucket"
                                />
                                <span class="ms-2"
                            ...
                            >
                                <img
                                    src="{{ asset("assets/admin/images/brands/dribbble.svg") }}"
                                    class="avatar-xs"
                                    alt="dribbble"
                                />
                                <span class="ms-2"
                            ...
                            >
                                <img
                                    src="{{ asset("assets/admin/images/brands/dropbox.svg") }}"
                                    class="avatar-xs"
                                    alt="dropbox"
                                />
                                <span class="ms-2"
                            ...
                            >
                                <img
                                    src="{{ asset("assets/admin/images/brands/slack.svg") }}"
                                    class="avatar-xs"
                                    alt="mail_chimp"
                                />
                                <span class="ms-2"
                ...
                <div class="dropdown topbar-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Xoş Gəldin {{ auth()->user()->name }}</h6>
