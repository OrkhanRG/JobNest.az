                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    <div class=" form-check">
                                        ...
                                        <label class="form-check-label rem-forgot" for="remember_me">Məni xatırla <a href="javascript:void(0);" data-bs-target="#forgot_password_popup" data-bs-toggle="modal" data-bs-dismiss="modal">Şifrəmi unutdum</a></label>

                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <button data-role="btn-login" type="submit" class="site-button">Daxil ol</button>
                                <div class="mt-3 mb-3">Hesabınız yoxdur ?
                                    <button class="twm-backto-login" data-bs-target="#sign_up_popup" data-bs-toggle="modal" data-bs-dismiss="modal">Qeydiyyatdan keçin</button>
                                </div>
                            </div>
